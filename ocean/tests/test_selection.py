...
@pytest.mark.parametrize("attr, value, expected, nullable, dtype", [
    ...
    for attr, (dtype, _, nullable) in {**CONTOUR_STATISTICS, **SELECTION_TABLE}.items()
...
def test_set_contour_statistics(selection: models.Selection, attr: str, value, expected, nullable: bool, dtype):
